...
struct llnode *cons_down( struct llnode *initial){
...
struct llnode *cons_grid(int hs, int vs, struct llnode *initial){
...
void free_grid(struct llnode *initial){
    ...
    struct llnode *llnodev;
    struct llnode *llnodeh;
    struct llnode *backupv;
    struct llnode *backuph;
